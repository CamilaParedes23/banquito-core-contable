...
LABEL org.opencontainers.image.title="core-accounting-service" \
      org.opencontainers.image.description="Banco BanQuito V2 - Core Accounting, journal entries, EOD and trial balance" \
